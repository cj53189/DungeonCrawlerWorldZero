...
function resetRunProgress() {
  ...
  player.inventory = [];
  player.equipment = {weapon:null,body:null,offhand:null,trinket:null};
  player.coins = 0;
...
function resetState(options = {}) {
  ...
  const lootPanel=document.getElementById("lootPanel"); if(lootPanel) lootPanel.style.display="none";
