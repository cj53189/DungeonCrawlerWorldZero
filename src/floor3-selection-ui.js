...
(function installFloor3SelectionUi() {
  ...
  function confirmFloor3Selection() {
    ...
    if (typeof applyProgressionBonuses === "function") applyProgressionBonuses();
